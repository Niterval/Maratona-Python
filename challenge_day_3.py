...
def add_food(food_name='', description=''):
    if food_name =='' or description =='':
        print('Você pecisa passar o nome da comida mais a descrição.')

    elif food_name != str(food_name) or description != str(description):
        print('Ambos valores precisam ser do tipo string.')

    elif food_name in food_list:
        print(f'{food_name} já está na lista')
    else:
        food_list[food_name] = description
        # print(food_list)
...
def delete_food(food_name=''):
    if food_name =='':
        ...
        if food_name not in food_list:
            ...
            food_name in food_list
            del food_list [food_name]
            # print(food_list)

########################## UPDATE FOOD LIST ######################

def update_food(food_name='', description=''):
    if food_name =='' or description =='':
        print('Você pecisa passar o nome da comida mais e a descrição.')
        ...
        if food_name not in food_list:
            print(f'{food_name} não existe na lista')
...
def get_food(food_name=''):
    if food_name == '':
        ...
        print('Você precisa passar o nome da comida pra consulta.')

    else:
        if food_name not in food_list:
            print(f'{food_name}, não existe no dicionário')

        else:
            desc = food_list[food_name]
            # print(food_list)
            print(f'A descrição de {food_name} é: {desc}')
